...
const fixture: any = {
  "Mozilla/5.0 (Linux; Android 5.1.1; Nexus 9 Build/LMY48T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.83 Safari/537.36": {
    ...
    features: {
      transforms2d: { level: "unknown", needPrefix: false },
      flexbox: { level: "unknown", needPrefix: false },
    },
  },
  "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Win64; x64; Trident/5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 2.0.50727; Media Center PC 6.0)": {
    browser: { id: "ie", version: "9.0" },
    features: {
      transforms2d: { level: "full", needPrefix: true },
      flexbox: { level: "none", needPrefix: false },
    },
  },
  "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0; Xbox; Xbox One)": {
    browser: { id: "ie", version: "10.0" },
    features: {
      transforms2d: { level: "full", needPrefix: false },
      flexbox: { level: "partial", needPrefix: true },
    },
  },
  "Mozilla/5.0 (Windows NT 6.3; ARM; Trident/7.0; Touch; rv:11.0) like Gecko": {
    ...
    features: {
      transforms2d: { level: "full", needPrefix: false },
      flexbox: { level: "partial", needPrefix: false },
    },
  },
  "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36 Edge/12.0": {
    ...
    features: {
      transforms2d: { level: "full", needPrefix: false },
      flexbox: { level: "full", needPrefix: false },
    },
  },
  ...
  "Mozilla/5.0 (iPad; CPU OS 7_0_4 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11B554a Safari/9537.53": {
    ...
    features: {
      transforms2d: { level: "full", needPrefix: true },
      flexbox: { level: "full", needPrefix: true },
    },
  },
